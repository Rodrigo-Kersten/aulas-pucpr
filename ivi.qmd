...
escription: "Montagem dos gráficos do Valor de importância das principais espécies registras em inventário florestal"
author: "Rodrigo Kersten"
categories: [Botânica, Inventário e Avaliação da Biodiversidade, IVI, valor de importância, gráficos]
format:
  html:
    theme: 
      light: cosmo          
...
Para trocar as cores do gráfico, substituam 'Set2' (palette = 'Set2') pela paleta escolhida.

Vejam em [PalleteChart.pdf](files\PalleteChart.pdf){target="_blank" rel="noopener noreferrer"}
